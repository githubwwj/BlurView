...
public class BlurView extends FrameLayout {
    ...
    public BlurViewFacade setupWith(@NonNull View rootView) {
        return setupWith(rootView, getBlurAlgorithm(rootView.getContext()));
    }
    ...
    @NonNull
    private BlurAlgorithm getBlurAlgorithm(@NonNull Context context) {
        BlurAlgorithm algorithm;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
            algorithm = new RenderEffectBlur(context);
        } else {
